...
const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'timetable',
                loadComponent: () => import('./features/admin/timetable/timetable-management/timetable-management.component').then(m => m.TimetableManagementComponent)
            },
            {
                path: 'reports',
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        path: 'manual/:id',
                        loadComponent: () => import('./features/teacher/attendance/manual-attendance/manual-attendance.component').then(m => m.ManualAttendanceComponent)
                    },
                    {
                        path: 'face',
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        path: 'edit/:id',
                        loadComponent: () => import('./features/teacher/exams/edit-exam/edit-exam.component').then(m => m.EditExamComponent)
                    },
                    {
                        path: 'results/:id',
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        path: 'result/:id',
                        loadComponent: () => import('./features/student/exams/exam-result-student/exam-result-student.component').then(m => m.ExamResultStudentComponent)
                    }
                ]
            }
        ]
    },
    {
        ...
        children: [
            ...
            {
                path: 'fees',
                loadComponent: () => import('./features/parent/fees/fees.component').then(m => m.FeesComponent)
            }
        ]
    },
    {
